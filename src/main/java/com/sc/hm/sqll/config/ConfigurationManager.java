...
/**
 * Interface that represents the configuration manager. It exposes several APIs
 * to read and parse the configuration file to initialize the system.
 *
...
public interface ConfigurationManager {
    ...
    /**
     * Configure the SQL Lite.The method will read all the existing db
     * configurations from the file specified.
     *
     * @param file
     * @throws Exception
     */
