...
public class ConnectionCache {
    ...
    /**
     * Get a connection to the underlying database. This API will check if a
     * connection exists in the cache, if so then return the cached connection.
     * Otherwise create and open a new connection.
     *
     * @return Connection
     * @throws SQLException
     */
