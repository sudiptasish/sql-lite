 ...
 * configuration. The individual configuration are store in
 * {@link ConnectionConfig} class.
 *
...
public final class ConfigurationUtil {
    ...
    /**
     * API to configure the system. It reads the database connection details
     * from the XML file and keep it in local cache. It is, however, possible to
     * override the default config file, by providing the same via system
     * property: db.config.path.
     *
     * If no file is found in the classpath or in the specified directory,
