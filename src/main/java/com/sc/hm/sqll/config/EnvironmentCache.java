...
/**
 * Cache to store the connection config, that were just read from the
 * configuration file. Any newly created connection details will be kept in the
 * cache, by the time they are flushed to the disk.
 *
