...
/**
 * Connection config class encapsulates the connection details. SQLLiTE uses
 * type 4 jdbc driver for establishing connection to any RDBMS system, and all
 * the attributes required to make the remote connection are stored in this
 * class.
 *
