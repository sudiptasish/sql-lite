...
public abstract class ExecutionManager {
    ...
    /**
     * Create and return a new instance of default query execution manager.
     *
    ...
    /**
     * Create and return a new instance of schema query execution manager.
     *
    ...
    /**
     * Create and return a new instance of plan query execution manager.
     *
    ...
    /**
     * Create and return a new instance of DDL query execution manager.
     *
    ...
    /**
     * Prepare and execute any query coming from the worksheet window. Execution
     * Manager is responsible for preparing the query, invoking the underlying
     * query handler to populate the final result set and show it to client.
     *
     * Execution Manager also has a error handler associated to it. In case the
     * query fails to execute, the appropriate error (along with the stacktrace)
