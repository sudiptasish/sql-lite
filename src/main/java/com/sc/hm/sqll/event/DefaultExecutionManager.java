...
public class DefaultExecutionManager extends ExecutionManager {
    ...
    /**
     * Get the result set limit set in the worksheet. If no limit is specified,
     * then accept the default.
     *
     * @param ws
     * @return int
     */
    ...
    /**
     * Create a new table model object with the result set, and send it to the
     * result table.
     *
     * @param ws
     * @param data
