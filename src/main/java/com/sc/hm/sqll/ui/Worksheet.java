...
public class Worksheet extends JPanel {
    ...
    /**
     * Initialize the split pane. Left part will display the set of db
     * connections, while the right pane will have the sql worksheet.
     */
    ...
    /**
     * Check to see if the current result panel is being used to display query
     * execution plan or not.
     *
     * @return boolean
     */
